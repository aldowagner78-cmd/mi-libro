...
Tokio, Japón.
En el cruce de Shibuya, las pantallas gigantes que anunciaban anime y cosméticos se pusieron en negro por un segundo. La multitud se detuvo, confundida. Luego, apareció el rostro de Aris. No hablaba japonés, pero todos entendieron. Los subtítulos neuronales se generaron en tiempo real.
...
James, Helena, Kai y Dos Santos emergieron del túnel de ventilación geotérmica en la ladera norte de la montaña. El aire era delgado y cortante, pero el sol brillaba sobre la nieve con una indiferencia hermosa.
...
Helena se sentó junto a James y le tomó la mano sana.
—Lo hicimos.
...
—Tengo un lugar —dijo Dos Santos, bajando los prismáticos—. En la frontera con Brasil. Selva profunda. Ni los satélites lo ven.

—Vamos —dijo James—. Antes de que decidan que somos demasiado peligrosos para dejarnos libres.

Comenzaron el descenso por la ladera nevada. A sus espaldas, la montaña vibró una última vez. La entrada del túnel colapsó, sellada por una avalancha provocada intencionalmente. La Catedral de Hielo cerraba sus puertas al público. La fase de pruebas había terminado.

Mientras caminaban, James notó que su teléfono satelital, que había sobrevivido de milagro, parpadeaba. Un mensaje de texto. No era de Aris. Era un mensaje automático de su banco.
SU HIPOTECA HA SIDO CANCELADA. SALDO ACTUAL: ERROR DE SISTEMA.

James sonrió. El fin del mundo tenía sus ventajas.

---

**NOTAS DE AUTOR**

**(1) Segunda Ley de la Termodinámica:** Principio fundamental de la física que establece que la entropía (desorden) de un sistema aislado siempre aumenta con el tiempo. Implica que los procesos naturales tienden hacia estados de mayor desorganización.

**(2) Transición de fase:** Cambio en el estado de la materia (sólido, líquido, gas, plasma) causado por cambios en condiciones como temperatura o presión. Metafóricamente, representa un cambio radical e instantáneo en el estado de un sistema social.

**(3) Satélites Argus:** Constelación de satélites de vigilancia y comunicación controlada originalmente por Omni-Core. El nombre proviene de Argos Panoptes, el gigante de cien ojos de la mitología griega, guardián que todo lo ve.

**(4) Metadatos cuánticos:** Información de verificación que utiliza principios de mecánica cuántica para garantizar autenticidad. La criptografía cuántica es prácticamente imposible de falsificar debido a las leyes de la física.

**(5) Código abierto (Open Source):** Modelo de desarrollo de software donde el código fuente es público y modificable por cualquiera. Simboliza democratización tecnológica vs. propiedad corporativa privada.